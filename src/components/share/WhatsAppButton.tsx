...
import { formatEventMessage, getWhatsAppUrl } from '@/lib/whatsapp'
...
export default function WhatsAppButton({
  ...
  return (
    <Button
      ...
      size="lg"
      onClick={handleClick}
      className={`${className ?? ''} shadow-[0_0_15px_rgba(37,211,102,0.3)]`}
      aria-label="Condividi evento su WhatsApp"
    >
      <WhatsAppIcon />
